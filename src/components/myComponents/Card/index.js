    ...
    return (
        <CardContainer>
            ...
            <div className="card__header">
                <img className="card__img" src={props.img?props.img:typeTaskIcon} alt="icon"/>
                <div className="card__actions">
                    {verifyDateInPast(props.date)  &&
                    <div className="action__item" onClick={()=>{setSelectedTask(selected===1?0:1)}}>
                        {selected===1 &&
            ...
            <div className="card__infoArea">
                <div className="card__info"><span>Hora:</span>{props.start}</div>
                <div className="card__info"><span className="time">Até:</span>{props.end}</div>
                <div className="card__info">{importanceTitle[props.importance]}</div>
            </div>
            
            <div className="card__seeMore" onClick={()=>{setVisible(!visible)}}>clique para ver mais</div>
