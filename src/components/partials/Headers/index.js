...
const Headers = (props) => {
  ...
  useEffect(() => {
    setTimeout(() => {
      setVisibleOpacity(props.visibleHeader);
    }, 200);
  }, [props.visibleHeader]);
      ...
      <div className="header__content">
        <Link to="/" className="profile__container">
          <div className="profile__picture">
            <img
              src={
                getUser().profileImg === null || getUser().profileImg === ""
                  ? profileIcon
                  : getUser().profileImg
              }
              alt="icon"
          ...
          <div className="profile__name">{getUser().name}</div>
        </Link>
