      ...
      {loading === false && (
        <PageArea>
          ...
          <Modal visible={visibleCalendar} setVisible={setVisibleCalendar}>
            <Calendar onClickDay={(date, event) => setDateByCalendar(date)} />
          </Modal>
          ...
          <div className="home__header">
            ...
            <div
              className="home__addTask--mobile"
              onClick={() => {
                setVisibleModal(!visibleModal);
              }}
            >
            ...
            {filterTask === 3 && (
              <div
                ...
                className="home__addTask home__addTask--monthMobile"
              >
                <div className="addTask__icon">
                  <img src={calendarIcon} alt="icon" />
                </div>
